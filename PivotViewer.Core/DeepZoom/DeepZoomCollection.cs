...
public class DeepZoomCollection
{
	...
	public DeepZoomCollection(string sourceUri, IFileLoader? fileLoader = default)
	{
	...
	public async Task LoadItemAsync(string itemId, CancellationToken cancellationToken = default)
	{
		...
		using var stream = await fileLoader.LoadAsync($"{BaseUri}/{item.SourceUri}", cancellationToken);

		await LoadItemAsync(item, stream, cancellationToken);
	...
	private async Task LoadItemAsync(DeepZoomItem item, Stream stream, CancellationToken cancellationToken)
	{
	...
	private void ParseDziItem(DeepZoomItem item, XElement xmlImage)
	{
		...
		var image = new DeepZoomItemImage
		{
	...
	public IList<DeepZoomImageTile>? GetFullImageTiles(string itemId, int level)
	{
	...
	public DeepZoomImageTile? GetThumbnailImageTile(string itemId, int level)
	{
	...
	public IList<DeepZoomImageTile> GetImageTiles(string itemId, int level)
	{
