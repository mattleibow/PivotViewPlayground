...
public class TileLoader
{
	...
	private readonly ITileImageFileFetcher tileFetcher;
	...
	public TileLoader(ITileImageFileFetcher tileFetcher, ITileCache<ITileLoadingInfo> tileCache, int concurrentRequests)
	{
	...
	private async void ProcessRequest(LoadingTile loadingTile)
	{
		...
		try
		{
			image = await tileFetcher.FetchAsync(loadingTile.Uri);
