...
public class DeepZoomCollectionTileSourceUnitTests
{
	...
	{
		var morton = DeepZoomCollectionTileSource.GetMortonNumber(x, y);
		var point = DeepZoomCollectionTileSource.GetMortonPoint(morton);
	...
	{
		var actual = DeepZoomCollectionTileSource.GetMortonNumber(x, y);
