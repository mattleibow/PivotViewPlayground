...
public class TileLoaderUnitTest
{
	...
	class TestWaitingImageLoader : IImageLoader
	{
		public int LoadCount { get; set; }
	...
	class TestWaitingTileLoader : TileLoader
	{
		...
		public TestWaitingTileLoader(IImageLoader imageLoader, ITileCache<ITileLoadingInfo> tileCache, int concurrentRequests)
